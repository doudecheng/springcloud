...
import com.xqt.util.EncryptUtil;
...
public abstract class AbsRestClient {
	...
	public boolean isTest=Boolean.parseBoolean(smsFile.readProperty("is_test"));
	public String server=smsFile.readProperty("rest_server");
	public String sslIP=smsFile.readProperty("http_ssl_ip");
	public int sslPort=Integer.parseInt(smsFile.readProperty("http_ssl_port"));
	public String version=smsFile.readProperty("version");

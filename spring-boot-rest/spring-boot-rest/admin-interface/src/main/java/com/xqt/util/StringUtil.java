...
public class StringUtil {
     ...
     * 
     * @Title: getJsonValue
     * @Description: 获取json中的字段
     * @author LiangHua
     * @param jsonObj
     * @param key
     * @return
     */
    public static String getJsonValue(JSONObject 
    		jsonObj, String key) {
        return jsonObj.containsKey(key) ? jsonObj.getString(key) : null;
    }

    /**
     * 
     * @Title: encode
     * @Description: 将数据做encode编码
     * @author LiangHua
     * @param data
     * @return
     */
